  ...
  const teamMembers = [
    {
      ...
      name: 'Vanshika Singh',
      role: 'Database Development & Management',
      badge: 'Core Specialist',
      expertise: 'Database Architecture, Security & Record Systems',
      description: 'Designing robust data schemas, secure patient record management, and scalable query indexing for tele-screening workflows.',
    },
    {
      id: 2,
      image: '/team/member2.jpg',
      name: 'Amitesh Verma',
      role: 'Deployment & Model Integration',
      badge: 'Core Specialist',
      expertise: 'Cloud/Edge Deployment & ML Pipeline Integration',
      description: 'Architecting containerized deployments, edge-device optimizations, and seamless model inference pipelines in production.',
    },
    {
      id: 3,
      ...
      role: 'Team Leader',
      badge: 'Team Lead',
      expertise: 'System Architecture & Technical Project Leadership',
      description: 'Orchestrating end-to-end project strategy, cross-functional engineering, and clinical standards alignment for SIH 2026.',
    },
    {
      id: 4,
      image: '/team/member4.jpg',
      name: 'Anshu Prajapati',
      role: 'Backend Development & Design Lead',
      badge: 'Design & Backend Lead',
      expertise: 'FastAPI Backend Architecture & System Design',
      description: 'Engineering high-performance RESTful APIs, clinical processing pipelines, and leading intuitive architectural design.',
    },
    {
      id: 5,
      ...
      expertise: 'Deep Learning, EfficientNet-B0 & Retinal Computer Vision',
      description: 'Training EfficientNet-B0 transfer learning models, automated IQA filtering, and multi-class ICDR severity classification.',
    },
    {
      id: 6,
      ...
      expertise: 'Clinical UI/UX Design, React & Interactive Telemed Studio',
      description: 'Designing intuitive, high-performance interfaces and real-time interactive biomarker visualization tools for clinicians.',
    },
  ];
