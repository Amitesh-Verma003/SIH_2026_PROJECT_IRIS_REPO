...
export default function PatientRegistry({ 
  ...
  // Complete registry of patients for this doctor in this city & state
      ...
      <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-xl border-b border-slate-200 shadow-sm transition-all">
        <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12">
          <div className="flex items-center justify-between h-20 sm:h-22">
            ...
            {/* Right: Doctor & Location Pill & Launch Studio */}
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="hidden md:flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-slate-100 border border-slate-200 text-xs font-mono text-slate-700">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 pb-2 border-b border-slate-200/80">
            <div className="space-y-3 max-w-3xl text-left">
              ...
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                Consolidated diabetic retinopathy screening ledger for registered clinical triage at this healthcare center.
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div className="bg-white rounded-3xl p-5 sm:p-6 border border-slate-200 shadow-xs space-y-2 text-left">
            ...
            <div className="text-3xl sm:text-4xl font-extrabold text-amber-700 font-mono">
              {referableCount} <span className="text-sm font-bold text-slate-500">({Math.round((referableCount/totalPatients)*100)}%)</span>
            </div>
            <div className="text-xs text-slate-500 font-medium">
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {[
                ...
                { label: 'Referable DR (ΓëÑGr.2)', value: 'REFERABLE' },
